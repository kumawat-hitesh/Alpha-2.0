public class RecursionBasics {
    ...
    public static int firstOccurence(int arr[], int key, int i) { // find first occurence of number
        if (i == arr.length - 1) {
            return -1;
        }
        if (arr[i] == key) {
    ...
    public static int lastOccurence(int arr[], int key, int i) { // find last occurence of number
        if (i == arr.length) {
            return -1;
        }
    ...
    public static int power(int x, int n) { // calculate power of number(time complexity o(n))
        if (n == 0) {
            return 1;
        }
